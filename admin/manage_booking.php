                                    ...
                                    // Fetch data from the database
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                echo "<tr>";
                                                echo "<td><a href='' class='fw-bold text-secondary'>#" . $row['Book_ID'] . "</a></td>";
                                                echo "<td>" . $row['Name'] . "</td>";
                                                echo "<td>" . $row['Date_IN'] . " - " . $row['Date_OUT'] . "</td>";
                                                echo "<td><span class='badge bg-warning'>" . $row['status_booking'] . "</span></td>";
                                                echo "<td><span >" . $row['parkType'] . "</span></td>";
                                                echo "<td><span class='fw-bold ms-1'>" . $row['Amount'] . "</span></td>";
                                                echo "<td><span class='badge bg-primary'>" . $row['Payment_Status'] . "</span></td>";
                                                echo "<td>
                                                        <div class='btn-group' role='group' aria-label='Basic outlined example'>
                                                        <a href='update_payment.php?bookID=" . $row['Book_ID'] . "' class='btn btn-outline-secondary'><i class='icofont-edit text-success'></i></a>
                                                        <button type='button' class='btn btn-outline-secondary deleterow' onclick='deleteBooking(" . $row['Book_ID'] .")'><i class='icofont-ui-delete text-danger'></i></button>
