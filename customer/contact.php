...
<html lang="en">
		...
		<header>
			<div class="header-container">
				<nav class="header-nav-bar">
                    ...
                    <li class="header-nav-list"><a class="header-nav-link header-active" href="contact.php">Contact Us</a></li>
    ...
    <?php else: ?>
        ...
        <a class="header-btn header-btn-custom" href="../login.php">Log In</a>
    <?php endif; ?>
</li>
                </ul>
