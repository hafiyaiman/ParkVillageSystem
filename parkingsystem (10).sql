...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 09, 2024 at 05:12 PM
...
(1, '0', 7, 6, '2024-01-07', '2024-01-09', 'KLIA2', 'ds', 'fe', '', 1, 2, 'roof_parking', NULL),
...
(1, 'akim', '0138723421', 1, 'parit raja', NULL, 0),
...
(14, 'ifwat', '0138723121', 2, 'Parit Raja', NULL, 0);
...
CREATE TABLE `parking_availability` (
  ...
  `parking_type` int(50) DEFAULT NULL,
...
INSERT INTO `parking_availability` (`availability_id`, `Cust_ID`, `Book_ID`, `parking_type`, `available_date`, `date_start`, `date_end`) VALUES
(1, 7, 0, 1, NULL, '2024-01-09', '2024-01-12'),
(11, 0, 0, 2, NULL, NULL, NULL),
(23, NULL, 0, 2, NULL, NULL, NULL),
(25, NULL, 0, 1, NULL, NULL, NULL);
...
INSERT INTO `payment` (`Payment_ID`, `Cust_ID`, `Book_ID`, `deposit`, `Amount`, `Transaction_ID`, `Payment_Method`, `Payment_Status`) VALUES
(1, 7, 1, 0, 20.00, NULL, 'cash', 'pending'),
(2, 8, 2, 0, 20.00, NULL, 'cash', 'pending'),
(3, 9, 3, 0, 20.00, NULL, 'cash', 'pending'),
(4, 10, 4, 0, 30.00, NULL, 'cash', 'pending'),
(5, 11, 5, 0, 30.00, NULL, 'cash', 'pending'),
(6, 12, 6, 0, 20.00, NULL, 'cash', 'pending'),
(7, 13, 7, 0, 30.00, NULL, 'cash', 'pending');
...
(1, '', 'awat@gmail.com', '$2y$10$b3Q7KFKG6H7XnJFOuRs2LuDaZRx273ue7lMn0xnD3tbzkRrQ3H1m.', 'customer'),
(2, 'ifwat', 'zifwat001@gmail.com', '$2y$10$BXjOb.6AYAhMdG9TP2oxne0Thyvk3xJwR/vIW7l9wBFzhncsBbDxS', 'customer');
...
INSERT INTO `vehicle` (`Vehicle_ID`, `Cust_ID`, `Model`, `Color`, `Plate_Number`, `Book_ID`) VALUES
(6, 7, 'PERODUA', NULL, 'fe', 0),
(8, 9, 'dsa', NULL, 'dsa', 3),
(9, 10, 'dsa', NULL, 'dsa', 4),
(10, 11, 'dsa', NULL, 'asd', 5),
(11, 12, 'asd', NULL, 'dsad', 6),
(12, 13, 'dsa', NULL, 'dsa', 7);
...
ALTER TABLE `parking_availability`
  ...
  ADD KEY `parking_availability_ibfk_1` (`parking_type`),
...
--
ALTER TABLE `parking_availability`
  MODIFY `availability_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `parking_availability`
  ADD CONSTRAINT `parking_availability_ibfk_1` FOREIGN KEY (`parking_type`) REFERENCES `parking` (`park_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `parking_availability_ibfk_2` FOREIGN KEY (`Book_ID`) REFERENCES `booking` (`Book_ID`);
